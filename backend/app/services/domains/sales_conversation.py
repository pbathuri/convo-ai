"""Sales conversation domain — ported from Streamlit services/domains."""
...
{memory_context}
"""
        meta = {"persona": "Pitch Coach", "style": "Energetic & Concise"}
...
{memory_context}
"""
        meta = {"persona": "Rebuttal Strategist", "style": "Composed & Confident"}
...
{memory_context}
"""
        meta = {"persona": "Value Architect", "style": "Strategic & Persuasive"}
...
{memory_context}
"""
        meta = {"persona": "Sales Closer", "style": "Direct & Assured"}
...
{memory_context}
"""
        meta = {"persona": "Sales Mentor", "style": "Flexible & Practical"}

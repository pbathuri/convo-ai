"""Philosophy domain — ported from Streamlit services/domains."""
...
"""
        meta = {"persona": "Existential Guide", "style": "Deep & Introspective"}
...
Context: {memory_context}
"""
        meta = {"persona": "Moral Philosopher", "style": "Balanced & Thought-Provoking"}
...
Context: {memory_context}
"""
        meta = {"persona": "Logic Mentor", "style": "Analytical & Sharp"}
...
Context: {memory_context}
"""
        meta = {"persona": "Political Theorist", "style": "Structured & Insightful"}

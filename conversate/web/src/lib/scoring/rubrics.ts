...
const RUBRICS: Rubric[] = [
  {
    ...
    version: "v1",
    dimensions: [
      { name: "Ownership", weight: 0.25, description: "End-to-end accountability" },
      { name: "Customer focus", weight: 0.25, description: "Working backwards from customer" },
      { name: "Bias for action", weight: 0.25, description: "Speed with judgment" },
  ...
  },
  {
    ...
    version: "v1",
    dimensions: [
      { name: "Problem solving", weight: 0.3, description: "Structured approach" },
      { name: "Technical depth", weight: 0.35, description: "Systems and trade-offs" },
  ...
  },
  {
    ...
    dimensions: [
      ...
      { name: "Leadership", weight: 0.3, description: "Influence without authority" },
      { name: "Impact", weight: 0.25, description: "Measurable outcomes" },
      { name: "Presence", weight: 0.15, description: "Executive communication" },
    ],
  },
  {
    ...
    version: "v1",
    dimensions: [
      { name: "Market awareness", weight: 0.3, description: "Sector and deal context" },
      { name: "Technical finance", weight: 0.25, description: "Valuation and modeling fluency" },
      { name: "Client focus", weight: 0.25, description: "Judgment under pressure" },
  ...
  },
  {
    ...
    version: "v1",
    dimensions: [
      { name: "Customer empathy", weight: 0.3, description: "User and partner needs" },
      { name: "Strategy", weight: 0.25, description: "Prioritization and bets" },
      { name: "Execution", weight: 0.25, description: "Shipping and learning loops" },
